        ...
        <div className="container">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground font-sans leading-relaxed mb-8">
              Información legal sobre los términos de uso y responsabilidad del sitio web de Dextra Law Firm.
            </p>
              ...
              <div className="space-y-8 text-foreground font-sans leading-relaxed text-justify">
                ...
                <section>
                  ...
                  <div className="space-y-2">
                    <p><strong>Titular del sitio web:</strong> Adrián García Lledó</p>
                ...
                <section>
                  ...
                  <ol className="ml-4 mb-4 space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Hacer un uso adecuado y lícito del Espacio Web así como de los contenidos y servicios, de conformidad con: (i) la legislación aplicable en cada momento; (ii) las Condiciones Generales de Uso del Espacio Web; (iii) la moral y buenas costumbres generalmente aceptadas y (iv) el orden público.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">2.</span>
                      <span>Proveerse de todos los medios y requerimientos técnicos que se precisen para acceder al Espacio Web.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">3.</span>
                      <span>Facilitar información veraz al cumplimentar con sus datos de carácter personal los formularios contenidos en el Espacio Web y a mantenerlos actualizados en todo momento de forma que responda, en cada momento, a la situación real del Usuario. El Usuario será el único responsable de las manifestaciones falsas o inexactas que realice y de los perjuicios que cause a la empresa o a terceros por la información que facilite.</span>
                    </li>
                  </ol>
                  <p>
                  ...
                  <ol className="ml-4 mb-4 space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">1.</span>
                      <span>Hacer un uso no autorizado o fraudulento del Espacio Web y/o de los contenidos con fines o efectos ilícitos, prohibidos en las presentes Condiciones Generales de Uso, lesivos de los derechos e intereses de terceros, o que de cualquier forma puedan dañar, inutilizar, sobrecargar, deteriorar o impedir la normal utilización de los servicios o los documentos, archivos y toda clase de contenidos almacenados en cualquier equipo informático.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">2.</span>
                      <span>Acceder o intentar acceder a recursos o áreas restringidas del Espacio Web, sin cumplir las condiciones exigidas para dicho acceso.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">3.</span>
                      <span>Provocar daños en los sistemas físicos o lógicos del Espacio Web, de sus proveedores o de terceros.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">4.</span>
                      <span>Introducir o difundir en la red virus informáticos o cualesquiera otros sistemas físicos o lógicos que sean susceptibles de provocar daños en los sistemas físicos o lógicos de la empresa, proveedores o de terceros.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">5.</span>
                      <span>Intentar acceder, utilizar y/o manipular los datos de la empresa, terceros proveedores y otros Usuarios.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">6.</span>
                      <span>Reproducir o copiar, distribuir, permitir el acceso del público a través de cualquier modalidad de comunicación pública, transformar o modificar los contenidos, a menos que se cuente con la autorización del titular de los correspondientes derechos o ello resulte legalmente permitido.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">7.</span>
                      <span>Suprimir, ocultar o manipular las notas sobre derechos de propiedad intelectual o industrial y demás datos identificativos de los derechos de la empresa o de terceros incorporados a los contenidos, así como los dispositivos técnicos de protección o cualesquiera mecanismos de información que puedan insertarse en los contenidos.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">8.</span>
                      <span>Obtener e intentar obtener los contenidos empleando para ello medios o procedimientos distintos de los que, según los casos, se hayan puesto a su disposición a este efecto o se hayan indicado expresamente en las páginas web donde se encuentren los contenidos o, en general, de los que se empleen habitualmente en Internet por no entrañar un riesgo de daño o inutilización del Espacio web y/o de los contenidos.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">9.</span>
                      <div className="space-y-1">
                        ...
                        <p><span className="text-primary font-semibold">9.1</span> De cualquier forma sea contrario, menosprecie o atente contra los derechos fundamentales y las libertades públicas reconocidas constitucionalmente, en los Tratados Internacionales y en el resto de la legislación vigente.</p>
                        <p><span className="text-primary font-semibold">9.2</span> Induzca, incite o promueva actuaciones delictivas, denigratorias, difamatorias, violentas o, en general, contrarias a la ley, a la moral, a las buenas costumbres generalmente aceptadas o al orden público.</p>
                        <p><span className="text-primary font-semibold">9.3</span> Induzca, incite o promueva actuaciones, actitudes o pensamientos discriminatorios por razón de sexo, raza, religión, creencias, edad o condición.</p>
                        <p><span className="text-primary font-semibold">9.4</span> Incorpore, ponga a disposición o permita acceder a productos, elementos, mensajes y/o servicios delictivos, violentos, ofensivos, nocivos, degradantes o, en general, contrarios a la ley, a la moral, a las buenas costumbres generalmente aceptadas o al orden público. Induzca o pueda inducir a un estado inaceptable de ansiedad o temor.</p>
                        <p><span className="text-primary font-semibold">9.5</span> Induzca o incite a involucrarse en prácticas peligrosas, de riesgo o nocivas para la salud y el equilibrio psíquico.</p>
                        <p><span className="text-primary font-semibold">9.6</span> Se encuentra protegido por la legislación en materia de protección intelectual o industrial perteneciente a la sociedad o a terceros sin que haya sido autorizado el uso que se pretenda realizar.</p>
                        <p><span className="text-primary font-semibold">9.7</span> Sea contrario al honor, a la intimidad personal y familiar o a la propia imagen de las personas.</p>
                        <p><span className="text-primary font-semibold">9.8</span> Constituya cualquier tipo de publicidad.</p>
                        <p><span className="text-primary font-semibold">9.9</span> Incluya cualquier tipo de virus o programa que impida el normal funcionamiento del Espacio Web.</p>
                      </div>
                    </li>
                  </ol>
                  <p>
                ...
                <section>
                  ...
                  <ol className="ml-4 mb-4 space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">1.</span>
                      <span>Interferencias, interrupciones, fallos, omisiones, averías telefónicas, retrasos, bloqueos o desconexiones en el funcionamiento del sistema electrónico, motivadas por deficiencias, sobrecargas y errores en las líneas y redes de telecomunicaciones, o por cualquier otra causa ajena al control de la empresa.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">2.</span>
                      <span>Intromisiones ilegítimas mediante el uso de programas malignos de cualquier tipo y a través de cualquier medio de comunicación, tales como virus informáticos o cualesquiera otros.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">3.</span>
                      <span>Abuso indebido o inadecuado del Espacio Web.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 text-primary mt-0.5 flex-shrink-0">4.</span>
                      <span>Errores de seguridad o navegación producidos por un mal funcionamiento del navegador o por el uso de versiones no actualizadas del mismo. El administrador del espacio web se reservan el derecho de retirar, total o parcialmente, cualquier contenido o información presente en el Espacio Web.</span>
                    </li>
                  </ol>
                  <p>
                ...
                <div className="mt-12 p-6 bg-gradient-to-br from-primary/5 to-primary/10 rounded-lg border border-primary/20">
                  <div className="space-y-4">
                    <p className="text-sm text-foreground font-bold text-center">Para cualquier consulta sobre el Aviso Legal puede contactar con nosotros</p>
